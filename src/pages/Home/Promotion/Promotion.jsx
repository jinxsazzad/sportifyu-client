    ...
    <section className=" py-8">
      ...
      <div className="container mx-auto px-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-[#F98F6F] p-4 shadow-md flex justify-center items-center">
            <div>
          ...
          <div className="bg-[#3B9DB0] p-4 shadow-md flex justify-center items-center">
            <div>
            <h2 className="text-5xl font-bold mb-2 text-center">2</h2>
            <p className="text-gray-600 p-4 text-center">
              Our teachers are in the water with their students, figuring out
              what each kid needs to learn
            </p>
          ...
          <div className="bg-[#9D87C3] p-4 shadow-md flex justify-center items-center">
            <div>
            <h2 className="text-5xl font-bold mb-2 text-center">3</h2>
            <p className="text-gray-600 p-4 text-center">
              Our teachers are in the water with their students, figuring out
              what each kid needs to learn
            </p>
          ...
          <div className="bg-[#DA922C] p-4 shadow-md flex justify-center items-center">
            <div>
            <h2 className="text-5xl font-bold mb-2 text-center">4</h2>
            <p className="text-gray-600 p-4 text-center">
              Our teachers are in the water with their students, figuring out
              what each kid needs to learn
            </p>
