  ...
  return (
    <>
      <div className="lg:flex justify-center items-center text-justify">
        <div className="bg-[#60CD96] p-6 flex  lg:flex-col justify-center items-center gap-3">
          <FaBook className="text-5xl"></FaBook>
          <h4 className="text-2xl mt-2 mb-4 font-semibold">Unique Classes</h4>
          <p className="hidden lg:block">
            Our Special Education Program offers quality education to children
            with disabilities and developmental delays.
          </p>
        </div>
        <div className="bg-[#69D2E7] p-6 flex  lg:flex-col justify-center items-center gap-3">
          <FaRegSun className="text-5xl"></FaRegSun>
          <h4 className="text-2xl mt-2 mb-4 font-semibold">Full Day Session</h4>
          <p className="hidden lg:block">
        ...
        <div className="bg-[#F98F6F] p-6 flex  lg:flex-col justify-center items-center gap-3">
          ...
          <h4 className="text-2xl mt-2 mb-4 font-semibold">
            Qualified Teachers
          </h4>
          <p className="hidden lg:block">
